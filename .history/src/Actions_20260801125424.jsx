...
<Col align="center" md={5} className="mx-auto" style={{marginTop:"20px"}}>
...
<Form.Group className="mb-3" controlId="formBasicEmail">
  <Form.Select type ="dropdown" onChange={(e)=>setKontox1(e.target.value)}>
    <option value={kontox1}>Konto1</option>
    {number.map((account)=>(
...
<hr></hr>
 ...
 <Col>FRÅN (SEK): <input type="number" value={kredit} onChange={handleKredit} placeholder='kredit'/>&nbsp;
  </Col>
