...
const newTime1 = accounter.flatMap(item=>item).filter(item =>item.kontox_value==="112" && item.kontox1 ==="112") 
console.log(newTime1)
const exTime1 = newTime1.map(item=>item)
console.log(exTime1)

const newTime2 = accounter1.flatMap(item=>item).filter(item =>item.kontox_value==="112" && item.kontox1 ==="112")
