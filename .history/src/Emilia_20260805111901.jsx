...
//Resurs
const newRes = accounter.flatMap((item=>item).filter(item=>item.kontox_value==="128"))
const newRes1 = accounter.flatMap((item=>item).filter(item=>item.kontox1_value==="128"))
