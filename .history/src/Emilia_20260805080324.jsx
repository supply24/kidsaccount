...
//112
const newTime1 = accounter.flatMap(item=>item).filter(item =>item.kontox_value==="112"||item.kontox1_value==="112")
const newArr1 = newTime1.reduce((acc, item) => acc + parseFloat(item.debet_value), 0);
const newKredit = newTime1.reduce((acc, item)=>acc+parseFloat(item.kredit_value),0)
console.log(newArr1, newKredit)
