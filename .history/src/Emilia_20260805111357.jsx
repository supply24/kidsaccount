...
//112
const newKontox = accounter1.map(item=>item).filter(item =>item.kontox_value==="112")
const newKontox1 = accounter1.map(item=>item).filter(item =>item.kontox1_value==="112")
...
//Resurs
const newRes = accounter1.map((item=>item).filter(item=>item.kontox_value==="e891"))
const newRes1 = accounter1.map((item=>item).filter(item=>item.kontox1_value==="e891"))
