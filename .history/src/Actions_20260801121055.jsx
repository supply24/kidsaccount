 ...
 // const [ setSumx ]=useState("")
  ...
  const handleDatetime=(e)=>{
    setDatetime(e.target.value)
      ...
      const payload= [{
    konto :{ kredit, debet, kontox}, datetime, texting
               }]
      ...
      const payload1 = [{
        konto1 :{ kredit, debet, kontox}, datetime, texting
                   }]
...
<input type="text" value={texting} onChange={handleTexting} placeholder='text'/>&nbsp;
...
<Col align="center" md  ={4} className="mx-auto" style={{marginTop:"20px"}}>      
  ...
  <Button variant="primary" type="submit" style={{marginBottom:20}}>Submit</Button>
</Form>
      </Card>
    </Container>
