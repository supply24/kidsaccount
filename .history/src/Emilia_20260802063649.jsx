...
const newTime2 = accounter1.flatMap(item=>item).filter(item =>item).filter(item =>item.kontox_value==="112")
const newMap = newTime2.map(item=>item.newsum)
console.log(newTime2)
console.log(newMap.reduce((acc, curr)=>acc+curr, 0))
console.log(newMap(item=>newSum))
