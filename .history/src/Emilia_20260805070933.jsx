...
const newArr1 = newTime1.reduce((acc, item) => acc + parseFloat(item.debet_value) - parseFloat(item.kredit_value), 0);
const newArr2 = newTime2.reduce((acc, item) => acc + parseFloat(item.debet_value) - parseFloat(item.kredit_value), 0);
